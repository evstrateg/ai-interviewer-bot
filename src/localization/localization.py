...
class LocalizationManager:
    ...
    def _get_russian_translations(self) -> Dict[str, str]:
        ...
        return {
            ...
            "welcome_greeting": "Привет, {username}! Я ИИ-интервьюер, специализирующийся на извлечении глубоких профессиональных инсайтов через структурированные беседы.",
            "welcome_what_i_do": "<b>Что я делаю:</b>",
            "welcome_features": [
                "• Провожу 9-этапные интервью для извлечения знаний",
                "• Извлекаю неявную экспертизу и лучшие практики",
                "• Задаю по одному фокусированному вопросу",
                "• Адаптируюсь к вашему стилю общения",
                "• Генерирую всесторонние инсайты"
            ],
            ...
            "prompt_master_desc": [
                ...
                "• Систематическое извлечение знаний",
                "• Лучше всего для детальной документации"
            ],
            "prompt_telegram_desc": [
                "📱 **Оптимизированный для Telegram**",
                "• Удобные для мобильных сообщения",
                "• Краткие, но тщательные",
                "• Отлично для быстрых интервью"
            ],
            "prompt_conversational_desc": [
                "💬 **Сбалансированная Беседа**",
                "• Естественный поток разговора",
                "• Поддерживает систематическое покрытие",
                "• Наиболее комфортный опыт"
            ],
            "prompt_stage_specific_desc": [
                "🎪 **Специфичный по Этапам**",
                "• Детальный подход для каждого этапа",
                "• Специализированные вопросы",
                "• Всестороннее покрытие"
            ],
            "prompt_conversation_mgmt_desc": [
                "🧠 **Управление Диалогом**",
                "• Продвинутые протоколы восстановления",
                "• Обрабатывает сложные ситуации",
            ...
            "interview_stages": [
                "1. **Приветствие** - Установление контакта (3-5 мин)",
                "2. **Профилирование** - Ваш бэкграунд (10 мин)",
                "3. **Суть** - Философия роли (15 мин)",
                "4. **Операции** - Рабочие процессы (20 мин)",
                "5. **Карта Экспертизы** - Уровни знаний (20 мин)",
                "6. **Типы Ошибок** - Частые проблемы (20 мин)",
                "7. **Мастерство** - Экспертные инсайты (15 мин)",
                "8. **Путь Развития** - Временная линия развития (15 мин)",
                "9. **Заключение** - Финальная валидация (5 мин)"
            ],
